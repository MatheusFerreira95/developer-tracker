...
/**
 * NavigateGraph Vue Wrapper
 * Michael Wang
 */
import _object from 'lodash/object';
import colors from 'vuetify/es5/util/colors';

const NavigateGraph = window.navigateGraph || undefined;
if (NavigateGraph === undefined) {
  console.error('NavigateGraph is not defined');
}
// set color palette
const colorPalette = [];
...
// NavigateGraph.registerTheme('material', {
//   color: colorPalette,
//   graph: {
//     color: colorPalette
//   }
...
export default {
  ...
  props: {
    // args of  NavigateGraph.init(dom, theme, opts)
    ...
    colors: Array, // navigateGraph.option.color
  ...
  methods: {
    init() {
      ...
      this.chartInstance = NavigateGraph.init(this.$refs.canvas, 'material');
